...
sap.ui.define([
		...
		return BaseController.extend("abc.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("abc.view.ViewSettingsDialog", this);
